<?php
class PDL_FieldTypes_TextField extends PDL_Form_Field_Type {

    public function __construct() {
        parent::__construct( _x('Textfield', 'form-fields api', 'PDM') );
    }
    ...
    public function render_field_inner( &$field, $value, $context, &$extra=null, $field_settings = array() ) {
        ...
        if ( $field->has_validator( 'date' ) )
            $html .= _x( 'Format 01/31/1969', 'form-fields api', 'PDM' );
