<?php
function pdl_admin_sidebar() {
    return pdl_render_page( PDL_PATH . 'templates/admin/sidebar.tpl.php' );
}

function pdl_admin_header( $args_or_title = null, $id = null, $h2items = array(), $sidebar = null ) {
    ...
    $id = str_replace( array( 'pdl_', 'pdl-' ), '', $id );
    $id = str_replace( array( 'admin-', 'admin_' ), '', $id );

    ob_start();
?>
<div class="wrap pdl-admin pdl-admin-page pdl-admin-page-<?php echo $id; ?>" id="pdl-admin-page-<?php echo $id; ?>">
	<div id="icon-edit-pages" class="icon32"></div>
		...
		<?php echo $sidebar = $sidebar ? pdl_admin_sidebar() : ''; ?>

		<div class="pdl-admin-content <?php echo ! empty( $sidebar ) ? 'with-sidebar' : 'without-sidebar'; ?>">
<?php
    return ob_get_clean();
}


function pdl_admin_footer() {
    ob_start();
?>
