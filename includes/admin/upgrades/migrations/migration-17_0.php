...
class PDL__Migrations__17_0 extends PDL__Migration {
    ...
    private function get_list_form_fields() {
        ...
        foreach ( pdl_get_form_fields( $find_params ) as $form_field ) {
            $form_fields[ "_pdl[fields][" . $form_field->get_id() . "]" ] = $form_field;
        }
    ...
    public function upgrade_to_16_fix_form_fields_data() {
        ...
        $message = _x( 'Cleaning up stored meta data for Checkbox, Radio and Select fields... (%d records left)', 'installer', 'PDM' );
