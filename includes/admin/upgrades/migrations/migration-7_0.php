...
class PDL__Migrations__7_0 extends PDL__Migration {

    public function migrate() {
        global $wpdb;

        $fields = $wpdb->get_results( $wpdb->prepare( "SELECT id, field_type FROM {$wpdb->prefix}pdl_form_fields WHERE field_type IN (%s, %s, %s, %s) AND association = %s",
