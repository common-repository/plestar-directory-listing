...
class PDL__Migration {
    ...
    public function request_manual_upgrade_with_configuration( $callback, $config_callback ) {
        ...
        update_option( 'pdl-manual-upgrade-pending', $manual_upgrades );
    }

    public function run_manual_upgrade() {
        $default_status = _x( 'Migrating Plestar Directory Listing database to version <version>.', 'installer', 'PDM' );
