...
class PDL_CategoryFormInputWalker extends Walker {
    ...
    public function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 ) {
        switch ( $this->input_type ) {
            case 'checkbox':
                $output .= '<div class="pdl-form-field-checkbox-item pdmcheckboxclass">';
            ...
            case 'radio':
            default:
                $output .= sprintf( '<div class="pdm-form-field-radio-item"><input type="radio" name="%s" class="%s" value="%s" %s style="margin-left: %dpx;"> %s</div>',
                                    'listingfields[' . $this->field->get_id() . ']',
