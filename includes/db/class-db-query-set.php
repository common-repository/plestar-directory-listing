 ...
 * @since 5.0
 */
class PDL__DB__Query_Set implements IteratorAggregate {
    ...
    public function __construct( $model, $query = null, $is_manager = false ) {
        ...
        $this->db = $wpdb;
        $this->model = is_array( $model ) ? $model : PDL__DB__Model::get_model_info( $model );
    ...
    public function to_array() {
        ...
        foreach ( $this->rows as $r ) {
            $res[] = PDL__DB__Model::from_db( $r, $this->model['class'] );
        }
