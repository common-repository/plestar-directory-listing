<?php
require_once ( PDL_PATH . 'includes/db/class-db-query-set.php' );

class PDL__DB__Model {
    ...
    public static function _objects( $classname ) {
        ...
        if ( ! isset( $managers_per_class[ $classname ] ) )
            $managers_per_class[ $classname ] = new PDL__DB__Query_Set( $classname, false, true );
...
require_once( PDL_PATH . 'includes/compatibility/deprecated/class-db-model2.php' );
