<?php
require_once( PDL_PATH . 'includes/class-module.php' );
...
class PDL__Modules {
    ...
    private function register_modules() {
        ...
        do_action( 'pdl_load_modules', $this );
        ...
        foreach ( $this->modules as $mod ) {
            ...
            if ( ! $mod->is_premium_module ) {
                ...
                $valid = pdl()->licensing->add_item_and_check_license( array( 'item_type' => 'module', 'name' => $mod->title, 'file' => $mod->file, 'version' => $mod->version ) );
            }
    ...
    public function load( $module ) {
        try {
            ...
            $wrapper = new PDL__Module( $module );
