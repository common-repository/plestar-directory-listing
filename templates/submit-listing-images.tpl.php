...
?>
<?php if ( ! $admin ): ?>
<h4><?php _ex( 'Current Images', 'templates', 'PDM' ); ?></h4>
<?php endif; ?>

<div id="no-images-message" style="<?php echo ( $images ? 'display: none;' : '' ); ?>"><?php _ex( 'There are no images currently attached to your listing.', 'templates', 'PDM' ); ?></div>
<div id="pdl-uploaded-images" class="cf">
...
foreach ( $images as $image_id ):
    ...
    echo pdl_render( 'submit-listing-images-single', $vars, false );
endforeach;
?>
</div>
...
echo pdl_render( 'submit-listing-images-upload-form', $vars, false );
?>

<script type="text/javascript">
pdl.listingSubmit.images.init();
</script>
