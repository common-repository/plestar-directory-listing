<?php
    _x( 'A listing has been reported as inappropriate. Listing details can be found below.', 'emails', 'PDM' );
?>
...
<?php _ex( 'Report IP', 'notify email', 'PDM' ); ?>: <?php echo $report[ 'ip' ]; ?>

<?php _ex( 'Report selected option', 'notify email', 'PDM' ); ?>: <?php echo $report[ 'reason' ]; ?>.

<?php echo isset( $report[ 'comments' ] ) && '' != $report[ 'comments' ] ? _x( 'Report additional info', 'notify email', 'PDM' ) . ': ' . $report[ 'comments' ] : ''; ?>