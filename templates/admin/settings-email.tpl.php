<?php
$uid = ! empty( $uid ) ? $uid : uniqid( 'pdl-settings-email-' );
...
$email_subject = ! empty( $email_subject ) ? $email_subject : _x( 'Untitled', 'settings email', 'PDM' );
...
<div class="pdl-settings-email <?php echo $container_class; ?>">
    <?php if ( ! $editor_only ): ?>
    <?php echo $before_preview; ?>
    <div class="pdl-settings-email-preview" title="<?php _ex( 'Click to edit e-mail', 'settings email', 'PDM' ); ?>">
        <a href="#" class="pdl-settings-email-edit-btn pdl-tag"><?php _ex( 'Click to edit', 'settings email', 'PDM' ); ?></a>
    ...
    <div class="pdl-settings-email-editor">
        ...
        <tbody>
            <tr>
                <th scope="row"><label for="<?php echo $uid; ?>-subject"><?php _ex( 'E-Mail Subject', 'settings email', 'PDM' ); ?></label></th>
                <td>
            ...
            <tr>
                <th scope="row"><label for="<?php echo $uid; ?>-body"><?php _ex( 'E-Mail Body', 'settings email', 'PDM' ); ?></label></th>
                <td>
                    <textarea name="<?php echo $setting_name; ?>[body]"  id="<?php echo $uid; ?>-body" class="email-body" placeholder="<?php _ex( 'E-mail body text', 'expiration notices', 'PDM' ); ?>"><?php echo esc_textarea( $email_body ); ?></textarea>

                    <?php if ( $placeholders ): ?>
                    <div class="placeholders">
                        <p><?php _ex( 'You can use the following placeholders:', 'settings email', 'PDM' ); ?></p>
        ...
        <div class="buttons">
            ...
            <!-- <a href="#" class="button preview-email"><?php _ex( 'Preview e-mail', 'settings email', 'PDM' ); ?></a> -->
            <a href="#" class="button cancel"><?php _ex( 'Cancel', 'settings email', 'PDM' ); ?></a> 
            <input type="submit" class="button button-primary" value="<?php _ex( 'Save Changes', 'settings email', 'PDM' ); ?>" />
