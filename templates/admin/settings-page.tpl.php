...
echo pdl_admin_header( array(
    'title'   => __( 'Plestar Directory Listing Settings', 'PDM' ),
    'buttons' => array( _x( 'Reset Defaults', 'settings', 'PDM' ) => add_query_arg( 'reset_defaults', 1 ) )
) );
?>

<h2 class="nav-tab-wrapper">
    <?php foreach ( $tabs as $tab_id => $tab ): ?>
    <a class="nav-tab <?php echo $active_tab == $tab_id ? 'nav-tab-active' : ''; ?> <?php echo apply_filters( 'pdl_settings_tab_css', '', $tab_id ); ?>" href="<?php echo esc_url( add_query_arg( 'tab', $tab_id ) ); ?>"><?php echo $tab['title']; ?></a>
    <?php endforeach; ?>
</h2>

<?php if ( count( $subtabs ) > 1 || 'modules' == $active_tab ): ?>
<div class="pdl-settings-tab-subtabs pdl-clearfix">
    <ul class="subsubsub">
    <?php
    $n = 0;
...
<p class="pdl-settings-subtab-description pdl-setting-description"><?php echo $active_subtab_description; ?></p>
<?php endif; ?>
...
<?php
    ...
    if ( ! $custom_form ):
        settings_fields( 'pdl_settings' );
    endif;

    do_settings_sections( 'pdl_settings_subtab_' . $active_subtab );
...
<?php if (isset($_REQUEST['settings-updated'])): ?>
	<div class="updated fade">
		<p><?php _e('Settings updated.', 'PDM'); ?></p>
	</div>
<?php endif; ?>
</h3>
