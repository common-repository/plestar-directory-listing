<h3><?php _ex( 'Manage Recurring Payments', 'manage recurring', 'PDM' ); ?></h3>

<table id="pdl-manage-recurring">
    <thead>
        <th class="listing-title"><?php _ex( 'Listing', 'manage recurring', 'PDM' ); ?></th>
        <th class="subscription-details"><?php _ex( 'Subscription / Fee Plan', 'manage subscriptions', 'PDM' ); ?></th>
    </thead>
    <tbody>
    ...
    <tr>
        ...
        <td class="subscription-details">
            <?php
                ...
                $subscription_amount = pdl_currency_format( $fee->fee_price );
                ...
                $subscription_details = _x( '%s each %s days. Next renewal is on %s.', 'manage recurring', 'PDM' );
            ...
            <a href="<?php echo esc_url( $cancel_url ); ?>" class="cancel-subscription"><?php _ex( 'Cancel recurring payment', 'manage recurring', 'PDM' ); ?></a>
        </td>
    </tr>
    <?php endforeach; ?>
    </tbody>
